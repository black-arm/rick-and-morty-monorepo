...
describe('CardListComponent', () => {
    ...
    it('should click to next page', () => {
      ...
      component.pageSelected.pipe(first()).subscribe(result => nextPage = result)

      const nextButton = fixture.debugElement.query(By.css('[data-testid="next"]'));
      nextButton.nativeElement.click();
      const currentPage = fixture.debugElement.query(By.css('[data-testid="currentPage"]'));
      fixture.detectChanges();
    ...
    it('should click to prev page to 9', () => {
        ...
        component.pageSelected.pipe(first()).subscribe(result => prevPage = result)

        const prevButton = fixture.debugElement.query(By.css('[data-testid="prev"]'));
